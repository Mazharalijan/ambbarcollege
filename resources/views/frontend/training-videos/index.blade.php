                        ...
                        $.each(contacts, function (ket, row) {
                          ...
                          <div class="col-md-3 pt-3">
                            <div class="card p-3">
                                <div class="row">
                                  <div class="col-md-12">
                                    <a href="${baseUrl('training-videos-book-chapters/' + row.id)}" alt="book detail">
                                    ...
                                    <div class="col-md-2">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                               <a href="${baseUrl('training-videos-book-chapters/' + row.id)}" alt="book detail" class="dropdown-item"><i class="fa fa-eye"></i> View Detail </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
