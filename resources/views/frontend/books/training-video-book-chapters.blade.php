                    ...
                    <div class="col-12">
                        ...
                        <div class="card " >
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{route('book-chapter',[$id])}}" class="btn btn-default">Reset</a>
                            </div>
                        </div>
                        <!-- /.card -->
                    </div>
                        ...
                        $.each(contacts, function (ket, row) {
                          ...
                          <div class="col-md-3 pt-3">
                            <div class="card p-3">
                                <div class="row">
                                  <div class="col-md-12">
                                    <a href="${baseUrl('chapter/' + row.id)}" alt="book detail">
                                ...
                                <div class="row">
                                     <div class="col-md-12">
                                        <h5>${(row.chapter != '' && row.chapter != null) ? row.chapter.substring(0,15) :''}</h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <div class="dropdown">
                                            <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0)"
                                               aria-expanded="true">
                                                <i class="fa fa-sliders" aria-hidden="true"></i></a>
                                            <div class="dropdown-menu">
                                               <a href="${baseUrl('chapter/' + row.id)}" alt="book detail" class="dropdown-item"><i class="fa fa-eye"></i> View Detail </a>
