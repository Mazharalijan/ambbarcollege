    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Edit Chapter Training Video</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form role="form" method="post" action="{{route('admin.training-video.update',$chapter->id)}}"
                                  class="book-form" enctype="multipart/form-data">
                                @method('PUT')
                                <input type="hidden" value="{{$chapter->training_video}}" name="old_training_video">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select name="parent_id" id="parent_id" class="form-control select2" >
                                            ...
                                            @foreach($books as $book)
                                                <option value="{{$book->id}}" {{($book->id == $parent->id)?"selected":""}}>{{$book->title}} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="link" id="link" value="{{$chapter->link}}" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <div class="progress">
