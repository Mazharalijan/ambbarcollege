            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                {{--<a href="{{ route('admin.chapters.create') }}" class="add_advertiser">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <div class="row">
                                <div class="col-md-12 p-2"><h4>{{$book->title}}</h4></div>
                            </div>
                            <div class="row" id="result">
                                ...
                                {{-- <div class="col-md-4 pt-3">
                                     <div class="card p-3">
                                         <div class="row">
                                             <div class="col-md-12">
                                                 <img src="https://parlor.dev/uploads/book-images/book_1618612642.png"
                                         ...
                                         <div class="row">
                                             <div class="col-md-12">
                                                 <h3>Vel inventore molest</h3>
                                             </div>
                                         </div>
                                         <div class="row">
                                             <div class="col-md-10">
                                                 Deserunt commodo cil
                                             </div>
                                             <div class="col-md-2">
                                                 <div class="dropdown">
                                                     ...
                                                     <div class="dropdown-menu">
                                                         <a class="dropdown-item "
                                                            href="https://parlor.dev/admin/books/1/edit"><i
                                                                 class="fa fa-pen" aria-hidden="true"></i> Edit</a>
                                                         <form action="https://parlor.dev/admin/books/1"
...
@push('scripts')
    <script>
        ...
        function loadMore(page = 1, reset = false) {
            ...
            $.ajax({
                url: "{{route('admin.book-chapters-data')}}",
                data: {
                    page: page,
                    search: search,
                    id: "{{$id}}",
                        ...
                        $.each(contacts, function (ket, row) {
                          ...
                          <div class="col-md-3 pt-3">
                            <div class="card p-3">
                                <div class="row">
                                  <div class="col-md-12">
                                    <a href="${baseUrl('admin/chapters/' + row.id)}" alt="book detail">
                                        ...
                                        <div class="dropdown">
                                            <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:void(0)"
                                               aria-expanded="true">
                                                <i class="fa fa-sliders" aria-hidden="true"></i></a>
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item " href="${baseUrl('admin/chapters/' + row.id + '/edit')}" ><i class="fa fa-pen" aria-hidden="true"></i> Edit</a>
                                                <form action="${baseUrl('admin/chapters/' + row.id)}" class="ajax-form" method="POST">
                                                    <input type="hidden" name="_method" value="DELETE">
                                                    <button type="submit" class="dropdown-item"><i class="fa fa-trash" aria-hidden="true"></i> Delete</button>
                                                 </form>
                                                <a href="${baseUrl('admin/chapters/' + row.id)}" alt="book detail" class="dropdown-item"><i class="fa fa-eye"></i> View Detail </a>
