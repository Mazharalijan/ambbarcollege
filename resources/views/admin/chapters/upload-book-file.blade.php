                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Upload Book File</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form role="form" method="post" action="{{route('admin.books.upload-book-file-submit')}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="book_id" id="book_id" class="form-control">
                                            ...
                                            @foreach($books as $book)
                                                <option value="{{$book->id}}" >{{$book->title}} {{(!empty($book->chapter))?"( ".$book->chapter." )":""}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
